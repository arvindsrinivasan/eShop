...
if($_GET && $_GET['search']){
  ...
  foreach ($keys as $key){
      ...
      $query = $db->query("SELECT `product_id` FROM `keywords` WHERE `keyword` = '".$key."'");
  ...
  //array_push($product_ids,
      ...
      $query = $db->query("SELECT `product_id` FROM `keywords`");
...
<div class="container">
    ...
    <div>
      <form action="/eShop/home.php" method = "GET">
        <input type="text" placeholder="Search.." name="search">
        <button type="submit"><i class="fa fa-search glyphicon glyphicon-search"></i></button>
      </form>
    </div><br>
            ...
            <div class="thumbnail">
                <div class="caption">
                    <form action = "viewProduct.php" method = "POST">
                      <a onclick = "this.parentNode.submit()"><?php echo $row["name"]; ?></a>
